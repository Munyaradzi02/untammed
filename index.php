...
<head>
  ...
  <title>Untammed Creativity</title>
  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div class="logo float-left">
        <h1 class="text-light"><a href="index.html"><span>untammedcreativity</span></a></h1>
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-address">
              ...
              <h3>Address</h3>
              <address>6873 St. Joseph's Area, Mutare, zimbabwe</address>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-phone">
              ...
              <h3>Phone Number</h3>
              <p><a href="tel:+263783830449">+263 78 383 0449</a></p>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-email">
              ...
              <h3>Email</h3>
              <p><a href="mailto:untammedcreativity@gmail.com">untammedcreativity@gmail.com</a></p>
            </div>
          </div>
